(()=>{
  ...
  async function submit(event){
    ...
    const form=byId('checkout-form');if(!form)return;const button=byId('submit-order-btn');sending=true;if(typeof submitting!=='undefined')submitting=true;if(button){button.disabled=true;button.textContent='Validando e enviando...'}
    try{
